            ...
            <div className="slider-cnt">
                <Slider {...settings}>
                    <div className="slideList">
                        <img src="/images/bestBanner1.jpg" alt="" />
                    ...
                    <div className="slideList">
                        <img src="/images/bestBanner2.jpg" alt="" />
                        <div className="cntArea">
                    ...
                    <div className="slideList">
                        <img src="/images/bestBanner3.jpg" alt="" />
                        <div className="cntArea">
                            <div className="date">25.1.1</div>
                    ...
                    <div className="slideList">
                        <img src="/images/bestBanner4.jpg" alt="" />
                        <div className="cntArea">
                            <div className="date">25.1.1</div>
                    ...
                    <div className="slideList">
                        <img src="/images/bestBanner5.jpg" alt="" />
                        <div className="cntArea">
                    ...
                    <div className="slideList">
                        <img src="/images/bestBanner6.jpg" alt="" />
                        <div className="cntArea">
                            <div className="date">25.1.16</div>
                    ...
                    <div className="slideList">
                        <img src="/images/bestBanner7.jpg" alt="" />
                        <div className="cntArea">
                            <div className="date">25.1.1</div>
                    ...
                    <div className="slideList">
                        <img src="/images/bestBanner8.jpg" alt="" />
                        <div className="cntArea">
                            <div className="date">25.1.1</div>
                    ...
                    <div className="slideList">
                        <img src="/images/bestBanner9.jpg" alt="" />
                        <div className="cntArea">
                            <div className="date">25.1.1</div>
